...
class CalculateArtifactsCodec(
    ...
    override suspend fun ReadContext.decode(): AbstractTransformedArtifactSet.CalculateArtifacts {
        ...
        return AbstractTransformedArtifactSet.CalculateArtifacts(ownerId, FixedFilesArtifactSet(ownerId, files, calculatedValueContainerFactory), targetAttributes, capabilities, ImmutableList.copyOf(steps.map { BoundTransformStep(it.transformation, it.recreate()) }))
    }
