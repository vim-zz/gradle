...
* must not have a `rootProject.name` that is the same as a top-level project name of the composite build.
* must not have a `rootProject.name` that is the same as the composite build `rootProject.name`.
