...
class JavaEcosystemAttributeMatcherTest extends Specification {
    ...
    def matchConfigurations(List<List<AttributeContainerInternal>> candidates, AttributeContainerInternal requested) {
        ...
        def configurationMatches = schema.matcher().matches(selectionSchema, implicitVariants, requested, null, explanationBuilder)
        ...
        def variantMatches = schema.matcher().matches(selectionSchema, configurationVariants, requested, null, explanationBuilder)
