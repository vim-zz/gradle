...
public class TransformStep implements Transform, TaskDependencyContainer {
    ...
    private Try<TransformSubject> doTransform(TransformSubject subjectToTransform, InputFingerprinter inputFingerprinter, TransformDependencies dependencies, ImmutableList<File> inputArtifacts) {
