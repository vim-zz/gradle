...
public class LocalFileDependencyBackedArtifactSet implements TransformedArtifactSet, LocalDependencyFiles, VariantSelector.Factory {
    ...
    public ResolvedArtifactSet asTransformed(ResolvedVariant sourceVariant, VariantDefinition variantDefinition, ExtraExecutionGraphDependenciesResolverFactory dependenciesResolver, TransformedVariantFactory transformedVariantFactory) {
        return new TransformedLocalFileArtifactSet((SingletonFileResolvedVariant) sourceVariant, variantDefinition.getTargetAttributes(), variantDefinition.getTransform(), dependenciesResolver, calculatedValueContainerFactory);
    }
    ...
    private static class TransformedLocalFileArtifactSet extends AbstractTransformedArtifactSet implements FileCollectionInternal.Source {
        ...
        public TransformedLocalFileArtifactSet(SingletonFileResolvedVariant delegate,
            ...
            super(delegate.getComponentId(), delegate, attributes, Collections.emptyList(), transform, dependenciesResolver, calculatedValueContainerFactory);
