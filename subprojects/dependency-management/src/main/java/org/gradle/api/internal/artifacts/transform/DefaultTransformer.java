...
public class DefaultTransformer implements Transformer {
    ...
    @Override
    public TransformResult transform(Provider<FileSystemLocation> inputArtifactProvider, File outputDir, TransformDependencies dependencies, @Nullable InputChanges inputChanges) {
