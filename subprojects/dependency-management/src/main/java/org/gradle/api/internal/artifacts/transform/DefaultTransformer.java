...
public class DefaultTransformer implements Transformer {
    ...
    @Override
    public TransformResult transform(Provider<FileSystemLocation> inputArtifactProvider, File outputDir, ArtifactTransformDependencies dependencies, @Nullable InputChanges inputChanges) {
