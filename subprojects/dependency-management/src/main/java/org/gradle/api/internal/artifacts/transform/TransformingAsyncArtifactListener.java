...
public class TransformingAsyncArtifactListener implements ResolvedArtifactSet.Visitor {
    ...
    public static class TransformedArtifact implements ResolvedArtifactSet.Artifacts, RunnableBuildOperation {
        ...
        private final ImmutableAttributes target;
        private final List<BoundTransformStep> transformSteps;
        private Try<TransformSubject> transformedSubject;
        private Deferrable<Try<TransformSubject>> invocation;
        ...
        private boolean prepareInvocation() {
            ...
            Deferrable<Try<TransformSubject>> invocation = createInvocation();
            synchronized (this) {
        ...
        private Try<TransformSubject> finalizeValue() {
            synchronized (this) {
                if (transformedSubject != null) {
            ...
            Deferrable<Try<TransformSubject>> invocation;
            synchronized (this) {
            ...
            Try<TransformSubject> result = invocation.completeAndGet();
            synchronized (this) {
        ...
        private Deferrable<Try<TransformSubject>> createInvocation() {
            TransformSubject initialSubject = TransformSubject.initial(artifact);
            BoundTransformStep initialStep = transformSteps.get(0);
            Deferrable<Try<TransformSubject>> invocation = initialStep.getTransformStep()
        ...
        public void visit(ArtifactVisitor visitor) {
            Try<TransformSubject> transformedSubject = finalizeValue();
