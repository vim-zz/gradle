...
public class DefaultTransformOutputs implements TransformOutputsInternal {
    ...
    private final TransformResult.OutputTypeInferringBuilder resultBuilder;
    ...
    public DefaultTransformOutputs(File inputArtifact, File outputDir, FileLookup fileLookup) {
        ...
        this.resultBuilder = TransformResult.builderFor(inputArtifact, outputDir);
    }

    @Override
    public TransformResult getRegisteredOutputs() {
        TransformResult result = resultBuilder.build();
