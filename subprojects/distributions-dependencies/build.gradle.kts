...
val antVersion = "1.10.12"
val archunitVersion = "1.0.1"
val asmVersion = "9.4"
val awsS3Version = "1.12.372"
...
dependencies {
    ...
    constraints {
        ...
        api(libs.fastutil)              { version { strictly("8.5.11") }}
        ...
        api(libs.jcommander)            { version { strictly("1.82") }}
        api(libs.jetbrainsAnnotations)  { version { strictly("23.1.0") }}
        ...
        api(libs.plist)                 { version { strictly("1.26") }}
